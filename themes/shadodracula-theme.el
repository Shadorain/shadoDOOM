;;; shadodracula-theme.el - based on https://draculatheme.com/ -*- no-byte-compile: t; -*-
(require 'doom-themes)

;;
(defgroup shadodracula-theme nil
  "Options for doom-themes"
  :group 'doom-themes)

(defcustom shadodracula-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'shadodracula
  :type 'boolean)

(defcustom shadodracula-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'shadodracula
  :type 'boolean)

(defcustom shadodracula-colorful-headers nil
  "If non-nil, headers in org-mode will be more colorful; which is truer to the
original Dracula Emacs theme."
  :group 'shadodracula
  :type 'boolean)

(defcustom shadodracula-comment-bg shadodracula-brighter-comments
  "If non-nil, comments will have a subtle, darker background. Enhancing their
legibility."
  :group 'shadodracula
  :type 'boolean)

(defcustom shadodracula-padded-modeline shadodracula-padded-modeline
...
(def-doom-theme shadodracula
  ...
  ((bg         '("#282a36" "#262626" nil            ))
   ...
   (selection      dark-blue)
   (builtin        orange)
   (comments       (if shadodracula-brighter-comments dark-cyan base5))
   (doc-comments   (doom-lighten (if shadodracula-brighter-comments dark-cyan base5) 0.25))
   (constants      cyan)
   (functions      green)
   (keywords       magenta)
   (methods        teal)
   ...
   (level1 magenta)
   (level2 violet)
   (level3 (if shadodracula-colorful-headers green   (doom-lighten violet 0.35)))
   (level4 (if shadodracula-colorful-headers yellow  (doom-lighten magenta 0.35)))
   (level5 (if shadodracula-colorful-headers cyan    (doom-lighten violet 0.6)))
   (level6 (if shadodracula-colorful-headers orange  (doom-lighten magenta 0.6)))
   (level7 (if shadodracula-colorful-headers blue    (doom-lighten violet 0.85)))
   (level8 (if shadodracula-colorful-headers magenta (doom-lighten magenta 0.85)))
   (level9 (if shadodracula-colorful-headers violet  (doom-lighten violet 0.95)))

   (hidden     base1)
   (-modeline-bright shadodracula-brighter-modeline)
   (-modeline-pad
    (when shadodracula-padded-modeline
      (if (integerp shadodracula-padded-modeline) shadodracula-padded-modeline 4)))
  ...
  ((elscreen-tab-other-screen-face :background "#353a42" :foreground "#1e2022")
   ...
   (font-lock-comment-face
    :foreground comments
    :background (if shadodracula-comment-bg (doom-lighten bg 0.05)))
   (font-lock-doc-face
...
;;; shadodracula-theme.el ends here
